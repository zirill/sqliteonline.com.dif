...
(function (root, factory) {
    ...
    Toastify.lib = Toastify.prototype = {
        ...
        init: function (options) {
            ...
            this.options.closeOnClick = options.closeOnClick || false; // Show toast close icon
        ...
        buildToast: function () {
            ...
            if (this.options.closeOnClick) {
              ...
              divElement.addEventListener(
                  "click",
                  function (event) {
                    selfi.removeElement(divElement);
                  }
              );
            }
